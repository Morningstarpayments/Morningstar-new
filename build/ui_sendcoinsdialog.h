...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 MRNG"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 MRNG"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MRNG"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MRNG"));
        ...
        labelBalance->setText(QStringLiteral("123.456 MRNG"));
